...
TEST_F(OrderBookTestFixture, TestFAK) {
    ...
    // Miss
    SubmitFAK fak{MsgNumber{1}, client1.GetClientId(), pId,
                  Side::SELL,   Price{1.05},           Volume{1}};
    ob.FAK(fak);
    // EXPECT_TRUE(valid);
    EXPECT_EQ(expectedTob, ob.GetTopOfBook());

    fak = SubmitFAK{MsgNumber{2}, client1.GetClientId(), pId,
                    Side::BUY,    Price{1.05},           Volume{1}};
    ob.FAK(fak);
    // EXPECT_TRUE(valid);
    EXPECT_EQ(expectedTob, ob.GetTopOfBook());

    // Bad Price
    fak = SubmitFAK{MsgNumber{3}, client1.GetClientId(), pId,
                    Side::SELL,   Price{0.98},           Volume{1}};
    ob.FAK(fak);
    // EXPECT_FALSE(valid);

    fak = SubmitFAK{MsgNumber{4}, client1.GetClientId(), pId,
                    Side::BUY,    Price{1.28},           Volume{1}};
    ob.FAK(fak);
    // EXPECT_FALSE(valid);

    // Hit TOB first quote
    fak = SubmitFAK{MsgNumber{5}, client1.GetClientId(),
                    pId,          Side::SELL,
                    Price{1},     Volume{1}};
    ob.FAK(fak);
    // EXPECT_TRUE(valid);
    ...
    fak = SubmitFAK{MsgNumber{6}, client1.GetClientId(),
                    pId,          Side::BUY,
                    Price{1.1},   Volume{1}};
    ob.FAK(fak);
    // EXPECT_TRUE(valid);
    ...
    // Clear level
    fak = SubmitFAK{MsgNumber{7}, client1.GetClientId(),
                    pId,          Side::SELL,
                    Price{1},     Volume{12}};
    ob.FAK(fak);
    // EXPECT_TRUE(valid);
    ...
    // Trade on two levels
    fak = SubmitFAK{MsgNumber{8}, client1.GetClientId(),
                    pId,          Side::BUY,
                    Price{1.2},   Volume{10}};
    ob.FAK(fak);
    // EXPECT_TRUE(valid);
    ...
    // Fill one quote
    fak = SubmitFAK{MsgNumber{9}, client1.GetClientId(), pId,
                    Side::SELL,   Price{0.95},           Volume{8}};
    ob.FAK(fak);
    // EXPECT_TRUE(valid);
