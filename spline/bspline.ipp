...
BSpline<degree> BSpline<degree>::WeightedFit(const std::vector<std::pair<double, double>>& data, const std::vector<double>& weights, const std::vector<double>& knots)
{
    ...
    return BSpline<degree>(
        knots,
        std::vector<double>(controlPoints.data(), controlPoints.data()+controlPoints.size())
    );
}

template <unsigned int degree>
BSpline<degree> BSpline<degree>::Fit(const std::vector<std::pair<double, double>>& data, const std::vector<double>& knots)
{
