...
class LinearGaussian {
   ...
   public:
    LinearGaussian(const CoefMatrix& coefficients, const NoiseMatrix& covarianceMatrix)
    ...
    double Probability(const Eigen::VectorXd& output, const Eigen::VectorXd& input) const
    {
