...
StochasticVolatility::Vector StochasticVolatility::Mutate(const StochasticVolatility::Vector& input) const
{
...
double StochasticVolatility::Probability(const StochasticVolatility::Vector& obs, const StochasticVolatility::Vector& hidden) const
{
